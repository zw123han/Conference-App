 ...
 */
public class MessageInboxDataCollector extends CommandPresenter {
     ...
     */
    public MessageInboxDataCollector(Registrar reg, String username, ChatroomManager cm, HashMap<String, String> profanities) {
        this.reg = reg;
